package com.moomanow.web.common.web.struts;
...
import com.moomanow.web.common.label.service.LabelService;
...
//    private static final Map<String, Map<String,Message>> messageCache  = new ConcurrentHashMap<String, Map<String,Message>>();
    ...
    private static final ConfigService configService = ApplicationContextUtil.getBean(ConfigService.class);
    private static final MessageService messageService = ApplicationContextUtil.getBean(MessageService.class);
    private static final LabelService labelService= ApplicationContextUtil.getBean(LabelService.class);
    
    public DBTextProvider() {
	}
...
//    	}
    	...
    	Map<String, IMessage> message = messageService.getMessageMap(locale.getISO3Language().toUpperCase());//  messageCache.get(locale.getISO3Language().toUpperCase());
        if (message == null) {
            return null;
        }
        String out = null;
