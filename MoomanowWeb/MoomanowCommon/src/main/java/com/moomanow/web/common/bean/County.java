...
public class County  implements java.io.Serializable,com.moomanow.core.common.bean.EntityBean {
    ...
    public County(CountyId id, City city, String name, Long indexRow, String code, String code2, String code3, String status, Date createDate, String createUser, Date updateDate, String updateUser) {
       this.id = id;
       this.city = city;
       this.name = name;
...
@ManyToOne(fetch=FetchType.LAZY)
    @JoinColumns( { 
        ...
        @JoinColumn(name="ID_CITY", referencedColumnName="ID_CITY", nullable=false, insertable=false, updatable=false) } )
    public City getCity() {
        return this.city;
    }
